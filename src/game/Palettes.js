...
export const PALETTES = {
    ElectricNeon: {
        ...
        ground: { base: '#0f172a', dark: '#020617' },
    ...
    EarthyForest: {
        ...
        ground: { base: '#3f3f46', dark: '#18181b' },
    ...
    GoldenOpulence: {
        ...
        ground: { base: '#451a03', dark: '#2a1a1a' },
    ...
    PastelSerenity: {
        ...
        ground: { base: '#e2e8f0', dark: '#94a3b8' },
    ...
    IndustrialUrban: {
        ...
        ground: { base: '#262626', dark: '#171717' },
    ...
    RetroPop: {
        ...
        ground: { base: '#111827', dark: '#000000' },
    ...
    TwilightNoir: {
        ...
        ground: { base: '#000000', dark: '#020617' },
